...
use App\University\Application\University\UseCase\Remove\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_university_university_remove';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Remove command for University",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/university/universities/remove.{_format}',
        name: self::NAME,
