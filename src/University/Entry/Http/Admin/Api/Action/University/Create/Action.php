...
use App\University\Application\University\UseCase\Create\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_university_university_create';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Create command for University",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/university/universities/create.{_format}',
        name: self::NAME,
