...
use App\University\Application\Student\UseCase\Edit\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_university_student_edit';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Update command for Student",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/university/students/edit.{_format}',
        name: self::NAME,
