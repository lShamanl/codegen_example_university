...
use App\University\Application\Student\UseCase\Create\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_university_student_create';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Create command for Student",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/university/students/create.{_format}',
        name: self::NAME,
