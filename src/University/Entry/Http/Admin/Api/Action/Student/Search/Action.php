...
class Action
{
    public const NAME = 'api_admin_app_university_student_search';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Search query for Student",
     *     @OA\JsonContent(
     *          allOf={
     ...
     */
    #[Route(
        path: '/api/admin/university/students.{_format}',
        name: self::NAME,
    ...
    public function action(
        ...
        return $presenter->present(
            data: ApiFormatter::prepare([
                'data' => array_map(static function (Student $student) {
                    return CommonOutputContract::create($student);
